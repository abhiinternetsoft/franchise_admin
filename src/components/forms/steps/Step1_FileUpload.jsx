...
const Step1_FileUpload = ({ formik, onSkip, onNext }) => {
  ...
  return (
    <Paper elevation={3} className="shadow-none  step-forms Listing-stepforms">
      {/* Title */}
      <Box
        className="All-steps-section border mb-4"
      ...
      >
        ...
        >
          ...
          <Box sx={{ mb: 3 }}>
            <label htmlFor="FDD Insurance date" className="fdd-insuarance-date">
              FDD Issuance Date
            </label>
            <DatePicker
              value={
